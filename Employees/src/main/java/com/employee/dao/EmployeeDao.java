...
public interface EmployeeDao {
	void addEmployee(String fname, String lname, String dept, String DOB, String address, String email,
			JsonArray rolesArray, String hashPassword);

	void updateEmployee(String id, String fname, String lname, String dept, String DOB, String address, String email);
